...
var admin = {
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (utils.strncmp(result, "SUCCESS", 7)) {
                        window.location = "/sugandh-vatika/admin/dashboard.php";
                    } else {
                        alert("Error " + result);
                    }
                }
    ...
    dashboard: {
        ...
        modules: {
            "1": {
                "href": "/sugandh-vatika/admin/category_add.html",
                "image": "/sugandh-vatika/images/products.png",
                "name": "Categories",
    ...
    category: {
        add: function () {
            var timeout = null,
                ...
                var jsdata = utils.formToObject("#addCategoryForm");
